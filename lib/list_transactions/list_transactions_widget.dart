  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<TransactionsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<TransactionsRecord> listTransactionsTransactionsRecordList =
            snapshot.data;
        // Customize what your widget looks like with no query results.
        if (snapshot.data.isEmpty) {
          // return Container();
          // For now, we'll just include some dummy data.
          listTransactionsTransactionsRecordList =
              createDummyTransactionsRecord(count: 1);
        }
        final listTransactionsTransactionsRecord =
            listTransactionsTransactionsRecordList.first;
        return Scaffold(
          key: scaffoldKey,
